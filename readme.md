...
[![Build Status](https://travis-ci.org/pfichtner/spring-restbucks.png?branch=master)](https://travis-ci.org/pfichtner/spring-restbucks)
...
The [`restdocs`](https://github.com/pfichtner/spring-restbucks/tree/restdocs) branch contains the test for the order payment process augmented with setup to generate Asciidoctor snippets documenting the executed requests and expectations on the responses.
